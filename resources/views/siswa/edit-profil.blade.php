...
@section('container')
    <div class="container-fluid">
        ...
        <form method="post" action="/profil-siswa/{{ $student->id }}">
            @method('patch')
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('NISN') is-invalid @enderror" id="NISN" name="NISN" placeholder="Masukkan NISN" value="{{ auth()->user()->NISN }}">
                @error('NISN') <div class="invalid-feedback">{{ $message }}</div> @enderror
            </div>
            <div class="form-group">
                <label for="kelas">Kelas</label>
                <input type="text" class="form-control @error('kelas') is-invalid @enderror" id="kelas" name="kelas" placeholder="Masukkan Kelas" value="{{ auth()->user()->kelas }}">
