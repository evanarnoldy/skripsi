...
@section('container')
    <div class="container-fluid">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="title mt-4">Hasil Prestasi Belajar {{Auth::user()->kelas_diampu}}{{Auth::user()->unit}}</h1>
        </div>

        <div class="row" style="margin-bottom: 15px">
            <div class="col">
                <form class="form-inline" method="get" action="{{url('wali/filter-prestasiwali')}}">
            ...
            <div class="col-3">
                <form class="form-inline" method="get" action="{{url('wali/cari-prestasiwali')}}">
