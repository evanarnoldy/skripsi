...
@section('container')
    <div class="container-fluid">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="title mt-4">Hasil Korelasi Kelas {{auth()->user()->kelas_diampu}} {{auth()->user()->unit}}</h1>
        </div>

        <form class="form-inline" method="get" action="{{url('wali/filter-korelasiwali')}}" style="margin-bottom: 15px">
