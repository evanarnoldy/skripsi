...
@section('container')
    <div class="container-fluid">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="title mt-4">Grafik Korelasi Antara Kesehatan Mental dan Prestasi Belajar Sekolah</h1>
        </div>
...
@section('footer')
    ...
    <script>
        ...
        $('#chart').highcharts({
            ...
            title: {
                text: 'Grafik Kesehatan Mental dan Prestasi Belajar Bulan {{$bulan1}} Tahun {{$tahun1}}'
            },
            xAxis: {
                categories: [
