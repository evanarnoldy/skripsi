        ...
        @endif
            ...
            <div class="row no-gutters">
                <div class="col-md-3">
                    ...
                    <form enctype="multipart/form-data" action="{{url('guru/profil-guru')}}" method="POST">
                        @csrf
                ...
                <div class="col-md-9">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{url('guru/profil-guru/'.$user->id.'/edit-profil')}}" class="btn btn-primary">Edit profil</a>
                    </div>
                </div>
            </div>
