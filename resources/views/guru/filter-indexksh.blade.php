...
@section('container')
    <div class="container-fluid">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="title mt-4">Grafik Monitoring Kesehatan Mental Sekolah</h1>
        </div>

        <div class="row" style="margin-bottom: 15px">
            <div class="col">
                <form class="form-inline" method="get" action="{{url('guru/filter-indexksh')}}">
    ...
    <script>
        $('#chartksh').highcharts({
            ...
            title: {
                ...
                text: 'Grafik Kesehatan Mental Bulan {{$bulan1}} Tahun {{$tahun1}}',
                @elseif($getbulan != 'Pilih bulan' && $gettahun != 'Pilih tahun')
                text: 'Grafik Kesehatan Mental Bulan {{$getbulan}} Tahun {{$gettahun}}',
                @elseif($getbulan != 'Pilih bulan' && $gettahun == 'Pilih tahun')
                text: 'Grafik Kesehatan Mental Bulan {{$getbulan}} Tahun {{$tahun1}}',
                @elseif($getbulan == 'Pilih bulan' && $gettahun != 'Pilih tahun')
